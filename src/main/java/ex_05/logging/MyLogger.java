...
public class MyLogger {
    ...
    @Pointcut("execution(java.util.Map<String,Integer> ex_05.objects.Manager.*(..)) || execution(java.util.Map<String,Integer> ex_05.objects.FileManager2.*(..)) ")
    ...
    @Pointcut("execution(java.util.Set<String> ex_05.objects.Manager.*(..)) || execution(java.util.Set<String> ex_05.objects.FileManager2.*(..))")
